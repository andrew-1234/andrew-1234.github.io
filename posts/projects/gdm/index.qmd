...
description: |
  A case study using acoustic monitoring data to model changes in avian species
  composition within the Mulga Lands bioregion of Queensland.
author: "Andrew Schwenke"
---

Published in:

* [Open Ecoacoustics website](https://openecoacoustics.org/resources/use-cases/gdm/)
* [EcoCommons website](https://www.ecocommons.org.au/ecoacoustic-gdm-use-case/)
...
![Figure 1: Study site locations represented by pins (yellow: new regrowth,
green: intermediate regrowth, red: old growth). Inset map of Australia indicates
location of the study area.](./GDM_fig1.jpg){width=100%}
