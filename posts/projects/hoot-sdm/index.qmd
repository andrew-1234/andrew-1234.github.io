...
description: |
  A case study demonstrating the use of open access acoustic data and citizen
  science annotations to model Owl species distributions.

author: 
  - name: "Dr Andrew Schwenke"
  - name: "Dr Rob Clemens"
---
...
* [Open Ecoustics website](https://openecoacoustics.org/resources/use-cases/sdm/)
* [EcoCommons website](https://www.ecocommons.org.au/acoustic-sdm-use-case/)
...
![Figure 1: Hoot Detective website](./hoot_detective.png){width=50%}
...
![Figure 2: Histogram demonstrating total frequency of annotated audio segments per day in the Hoot Detective data set.](./hoot_segments_per_day.png)
...
![Figure 3: MaxEnt prediction of environmental suitability using Powerful Owl
prescence data and five environmental layers. Prescenes are marked with blue
circles \(note that some records are overlapping due to the scale\).](./gg_powl_maxent_stack1_prediction.png)
...
![Figure 4: Masked Owl distribution prediction using a Bioclim model (presence
only), generated on the EcoCommons
platform.](./maskedowl_BIOCLIM.png){width=50%}

![Figure 5: Masked Owl distribution prediction using a Artificial Neural Network
model (presence / absence data), generated on the EcoCommons
platform.](./maskedowl_ANN_w_absence_data.png){width=50%}
...
![Figure 6: Predicted call frequency (number of calls) of the Southern Boobook, using a Boosted Regression Tree.](./boobook_frequency.png)
